...
fun ElementType.labelResId(): Int = when (this) {
    ...
    ElementType.PROFILE_SWITCH    -> R.string.careportal_profileswitch
    ElementType.PROFILE_MANAGEMENT -> R.string.profile_management
    ElementType.TEMP_TARGET       -> R.string.temporary_target
    ...
    ElementType.CANNULA_CHANGE -> R.string.careportal_insulin_cartridge_change
